...
class Scene2Intro(Scene):
    def construct(self):
        ...
        self.play(FadeIn(rule_even, shift=RIGHT), run_time=1.0)
        self.wait(0.8)
        self.play(FadeIn(rule_odd, shift=RIGHT), run_time=1.0)
        self.wait(1.5)
        ...
        self.play(FadeIn(conjecture, shift=UP), run_time=1.0)
        self.wait(3.0)
        ...
        self.play(FadeIn(attribution), run_time=1.0)
        self.wait(4.0)
        self.play(FadeOut(quote), FadeOut(attribution), run_time=1.0)

        # ---------- Bridge into the next scene ----------
        bridge = Text("Let's see why.", font_size=34, color=CYAN)
        self.play(FadeIn(bridge, scale=0.8), run_time=1.0)
        self.wait(1.5)
